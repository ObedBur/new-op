...
export class LocationService {
  ...
  private getProvincesData(): Province[] {
    return [
      { name: 'Bas-Uele', code: 'BU', communes: ['Buta', 'Aketi', 'Bondo'] },
      {
        name: 'quateur',
        code: 'EQ',
        communes: ['Mbandaka', 'Bolomba', 'Bomongo'],
      },
      {
        name: 'Haut-Katanga',
        code: 'HK',
        communes: ['Lubumbashi', 'Likasi', 'Kipushi'],
      },
      ...
      { name: 'Haut-Uele', code: 'HU', communes: ['Isiro', 'Watsa', 'Dungu'] },
      {
        name: 'Ituri',
        code: 'IT',
        communes: ['Bunia', 'Aru', 'Mahagi', 'Djugu'],
      },
      ...
      { name: 'Kwango', code: 'KW', communes: ['Kenge', 'Popokabaka'] },
      {
        name: 'Kwilu',
        code: 'KL',
        communes: ['Bandundu', 'Kikwit', 'Bulungu'],
      },
      { name: 'Lomami', code: 'LO', communes: ['Kabinda', 'Mwene-Ditu'] },
      {
        name: 'Lualaba',
        code: 'LU',
        communes: ['Kolwezi', 'Dilolo', 'Sandoa'],
      },
  ...
  isValidProvince(provinceName: string): boolean {
    ...
    const exists = this.provinces.some(
      (p) => p.name.toLowerCase() === provinceName.toLowerCase(),
    );
  ...
  isValidCommune(provinceName: string, communeName: string): boolean {
    ...
    if (province) {
      return province.communes.some(
        (c) => c.toLowerCase() === communeName.toLowerCase(),
      );
    }
