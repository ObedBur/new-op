...
describe('PasswordService', () => {
    ...
    describe('validateComplexity', () => {
        ...
        it('should throw for a weak password (no uppercase)', () => {
            expect(() => service.validateComplexity('weakpass123!')).toThrow(common_1.HttpException);
        });
        it('should throw for a weak password (no number)', () => {
            expect(() => service.validateComplexity('StrongPass!')).toThrow(common_1.HttpException);
        });
        it('should throw for a short password', () => {
            expect(() => service.validateComplexity('P1!pas')).toThrow(common_1.HttpException);
        });
    });
