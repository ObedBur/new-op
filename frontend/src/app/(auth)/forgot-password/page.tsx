          ...
          {!isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full flex items-center justify-center bg-orange-500 hover:bg-orange-600 active:scale-[0.98] transition-all duration-200 rounded-xl h-[52px] shadow-lg shadow-orange-500/25 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center text-center animate-fade-in">
              <div className="w-20 h-20 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-10 h-10 text-orange-600 dark:text-orange-400">
