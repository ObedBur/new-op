    ...
    <aside className="hidden lg:block w-[280px] shrink-0 sticky top-24 self-start">
        <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
            ...
            <div className="mb-7">
                ...
                <div className="space-y-3.5">
                    <label className="flex items-center gap-3 cursor-pointer group">
                        <input type="checkbox" className="size-[18px] rounded-[4px] border-slate-300 text-[#E67E22] focus:ring-[#E67E22] accent-[#E67E22] transition-colors" />
            ...
            <div className="mb-7">
                ...
                <div className="space-y-3.5">
                    <label className="flex items-center gap-3 cursor-pointer group">
                        <input type="checkbox" defaultChecked className="size-[18px] rounded-[4px] border-slate-300 text-[#E67E22] focus:ring-[#E67E22] accent-[#E67E22] transition-colors" />
