...
export const ProductQuickView: React.FC<ProductQuickViewProps> = ({ product, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 md:p-12">
      ...
      <div className="relative w-full max-w-5xl bg-white dark:bg-[#111] rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-300 max-h-[92vh] border border-white/20">
          ...
          <div className="px-6 py-5 md:px-10 md:py-8 bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border-t border-slate-100 dark:border-white/5 sticky bottom-0 z-10 w-full">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full">
              ...
              <a
                ...
                className="flex-1 h-16 w-full border-2 border-[#25D366]/40 text-[#25D366] hover:border-[#25D366] hover:bg-[#25D366]/5 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-3 transition-all active:scale-95"
              >
