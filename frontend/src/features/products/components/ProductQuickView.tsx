...
export const ProductQuickView: React.FC<ProductQuickViewProps> = ({ product, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 md:p-12">
      ...
      <div className="relative w-full max-w-5xl bg-white dark:bg-[#111] rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-300 max-h-[85vh] border border-white/20">
        ...
        >
          <span className="material-symbols-outlined text-[18px] md:text-[24px] group-hover:rotate-90 transition-transform">close</span>
        </button>
        ...
        {/* Section Droite : Contenu scrollable + footer toujours visible */}
            ...
            <div className="p-4 sm:p-6 md:p-10 flex flex-col gap-4 md:gap-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-4 py-3 md:py-6 border-y border-slate-100 dark:border-white/5 text-xs md:text-sm font-medium text-slate-500">
                <div className="flex items-center gap-1.5 md:gap-2">
                  <span className="material-symbols-outlined text-[16px] md:text-[20px] text-[#E67E22]">location_on</span>
              ...
              {/* 3. Description */}
              <div>
                <h3 className="text-[10px] md:text-[11px] font-black text-slate-900 dark:text-white uppercase tracking-[0.2em] mb-2 md:mb-3">À propos de cet article</h3>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5 md:gap-2">
                      ...
                      {product.user?.isVerified && (
                        <span className="material-symbols-outlined text-blue-500 text-[16px] md:text-[20px] shrink-0" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
                      )}
                    </div>
                    <div className="flex items-center gap-2 mt-0.5 md:mt-1">
                      <div className="flex items-center text-[#E67E22] text-[10px] md:text-xs font-black">
                        <span className="material-symbols-outlined text-[12px] md:text-[14px] mr-1" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                        {trustScore} Score
                      </div>
                    </div>
                  </div>
