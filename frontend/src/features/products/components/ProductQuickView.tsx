          ...
          <div className="px-6 py-5 md:px-10 md:py-8 bg-white/95 dark:bg-[#111]/95 backdrop-blur-xl border-t border-slate-100 dark:border-white/5 sticky bottom-0 z-10 w-full">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full">
              ...
              <button
                ...
                className={`flex-1 h-14 w-full rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-3 shadow-lg transition-all active:scale-95 border-2 ${product.stockQuantity === 0
              ...
              <a
                ...
                className="flex-1 h-14 w-full border-2 border-[#25D366]/40 text-[#25D366] hover:border-[#25D366] hover:bg-[#25D366]/5 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-3 transition-all active:scale-95"
              >
